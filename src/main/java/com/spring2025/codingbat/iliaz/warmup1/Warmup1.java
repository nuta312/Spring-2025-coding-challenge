...
public class Warmup1 {
    ...
    */
    ...
    The value of n will be a valid index of a char in the original string (i.e. n will
    ...
    public String front3(String str) {
        return (str.length() >= 3) ? str.substring(0, 3).concat(str.substring(0, 3)).concat(str.substring(0, 3))
