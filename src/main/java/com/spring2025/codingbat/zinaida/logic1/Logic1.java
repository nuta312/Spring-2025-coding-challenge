...
nearTen(19) → true
    ...
    public boolean nearTen(int num) {
        ...
        int result = num % 10;
        int result2 = num % 10 + 2;
        if (result == 8 || result == 2 || result == 9 || result == 1 || result == 0) {
            return true;
        } else {
            return false;
        }
...
answerCell(true, false, false) → false
 ...
 1=good, or 2=great. A party is good (1) if both tea and candy are at least 5. However, if either tea or candy is at least double the amount of the other one, the party is great (2). However, in all cases, if either tea or candy is less than 5, the party is always bad (0).
...
fizzString("fib") → "FizzBuzz"
    ...
    public String fizzString(String str) {
        ...
        if ((str.startsWith("f") || str.startsWith("F")) && (str.endsWith("b") || str.endsWith("B"))) {
            return "FizzBuzz";
        }
        if (str.startsWith("f") || str.startsWith("F")) return "Fizz";
        if (str.endsWith("b") || str.endsWith("B")) return "Buzz";
        else return str;
...
maxMod5(3, 2) → 3
 ...
 value 2, the result is 10. Otherwise if they are all the same, the result is 5. Otherwise so long as both
