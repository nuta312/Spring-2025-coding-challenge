...
public class Warmup1 {
  ...
  /*  We have a loud talking parrot.
   The "hour" parameter is the current hour time
    in the range 0..23. We are in trouble if the parrot is
   ...
   /* Given an int n, return true if it
   is within 10 of 100 or 200.
   ...
   return a new string where the char at index n
    has been removed. The value of n will be a
   ...
   /* Given a string, we'll say that
    the front is the first 3 chars of
   ...
   /* Given a string, take the last char and return
    a new string with the last char added at the front and
   ...
   /* Return true if the given non-negative number
    is a multiple of 3 or a multiple of
...
and return the string with the 2 chars added at b
oth the front and back, so "kitten" yields"kikittenki". If the string length is less than 2, use whatever chars are there.
...
public boolean startHi(String str) {
  ...
  public boolean mixStart(String str) {
   ...
   is nearest to the value 10, or return 0 in the event
 ...
 */
  ...
  where the last 3 chars are now in upper case.
  ...
  public String endUp(String str) {
      if(str.length()<=3){
          ...
          String s1=str.substring(str.length()-3).toUpperCase();
